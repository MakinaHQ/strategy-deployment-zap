...
| File                                  | Safe                           | Purpose                                                                                             |
| ------------------------------------- | ------------------------------ | --------------------------------------------------------------------------------------------------- |
| `Base-stocks-oracle-feed-routes.json` | DAO safe `0x62244C74…` on Base | `setFeedRoute` on the OracleRegistry for the 7 tokenized stock accounting tokens (mirrors nonce 67) |
